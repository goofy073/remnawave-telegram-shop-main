...
func main() {
	...
	b.RegisterHandler(bot.HandlerTypeCallbackQueryData, handler.CallbackInstructions, bot.MatchTypeExact, h.InstructionsCallbackHandler, h.CreateCustomerIfNotExistMiddleware)
	b.RegisterHandler(bot.HandlerTypeCallbackQueryData, handler.CallbackInstructionsTV, bot.MatchTypeExact, h.InstructionsTVCallbackHandler, h.CreateCustomerIfNotExistMiddleware)
	b.RegisterHandler(bot.HandlerTypeCallbackQueryData, handler.CallbackInstructionsAndroid, bot.MatchTypeExact, h.InstructionsAndroidCallbackHandler, h.CreateCustomerIfNotExistMiddleware)
	b.RegisterHandler(bot.HandlerTypeCallbackQueryData, handler.CallbackInstructionsIOS, bot.MatchTypeExact, h.InstructionsIOSCallbackHandler, h.CreateCustomerIfNotExistMiddleware)
	b.RegisterHandler(bot.HandlerTypeCallbackQueryData, handler.CallbackInstructionsPC, bot.MatchTypeExact, h.InstructionsPCCallbackHandler, h.CreateCustomerIfNotExistMiddleware)
