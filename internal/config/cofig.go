...
type config struct {
	...
	supportURL                                                string
	tosURL                                                    string
	instructionsTVURL                                         string
	instructionsAndroidURL                                    string
	instructionsIOSURL                                        string
	instructionsPCURL                                         string
...
func InstructionsTVURL() string {
	return conf.instructionsTVURL
}

func InstructionsAndroidURL() string {
	return conf.instructionsAndroidURL
}

func InstructionsIOSURL() string {
	return conf.instructionsIOSURL
}

func InstructionsPCURL() string {
	return conf.instructionsPCURL
}
...
func InitConfig() {
	...
	conf.instructionsTVURL = os.Getenv("INSTRUCTIONS_TV_URL")
	conf.instructionsAndroidURL = os.Getenv("INSTRUCTIONS_ANDROID_URL")
	conf.instructionsIOSURL = os.Getenv("INSTRUCTIONS_IOS_URL")
	conf.instructionsPCURL = os.Getenv("INSTRUCTIONS_PC_URL")
